...
import com.asadchattha.tiktoklikesandfollowers.Adapters.PostAdapterFollower;
...
public class DoFollowingActivity extends AppCompatActivity {
    ...
    private PostAdapterFollower postAdapterFollower;
    ...
    private void readPosts() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                /* Show Empty Place Holder Identifier
                if(!posts.isEmpty()){
