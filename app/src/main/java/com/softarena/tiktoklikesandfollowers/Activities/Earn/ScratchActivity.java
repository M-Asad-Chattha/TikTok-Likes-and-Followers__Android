...
import com.softarena.tiktoklikesandfollowers.Activities.Designing.PopupActivity;
...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*SharedPref Helper*/
        sharedPrefrencesHelper = new SharedPrefrencesHelper(ScratchActivity.this);
    ...
    public void onClickScratchingLayout(View view) {
        Intent intent = new Intent(ScratchActivity.this, PopupActivity.class);
        intent.putExtra("Reward", rewardAmount);
